...
export function PositionTeaser({ standings }: { standings: StandingsSnapshot }) {
  return (
    <Link
      href="/fixtures"
      className="flex items-center justify-between gap-4 rounded-md border border-fg/10 bg-surface-2 px-4 py-3.5 text-fg no-underline shadow-resting transition-[background-color,box-shadow] hover:bg-[oklch(0.24_0.015_260)] hover:shadow-raised [clip-path:polygon(0_0,calc(100%-20px)_0,100%_20px,100%_100%,0_100%)]"
    >
